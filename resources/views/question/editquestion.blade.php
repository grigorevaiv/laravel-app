    ...
    <div class="col-md-10 text-center">
        <div class="card">
            <div class="card-header display-6">
                Edit the question with title {{ $question->title }}
            </div>
            ...
            <div class="p-4">
                <div class="container px-4 mx-auto py-16">
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-5">
                            <form action="{{ route('question.storechanges') }}" method="post">
                            @csrf
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="body" class="form-control" required>{{ old('body', $question->body) }}</textarea>
                                </div>
                                <br/>
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="category_id">
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" @if (old('category_id', $question->category_id) == $category->id) selected @endif>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
