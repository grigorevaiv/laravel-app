    ...
    <div class="rounded shadow mb-4 p-4 w-full hover:bg-gray-200">
        ...
        <div class="text-xs text-gray-600 flex items-center justify-between">
            <div class="flex gap-4">
                <a class="flex items-center uppercase" href="{{route('categories', $pregunta->category->slug)}}">
                ...
                <span class="flex gap-2">
                    ...
                    <a href="{{route('tags', $etiqueta->slug)}}" class="flex items-center capitalize">
            ...
            <div class="flex gap-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                    ...
                    <a href="{{ route('questions_user', $pregunta->user->name) }}">{{ $pregunta->user->name }}</a>
                </span>
                <span class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
                    ...
                    <a href="{{route('question', $pregunta->slug)}}" class="text-indigo-600">&nbsp;ver&#8594;</a>
                </span>
            </div>
        </div>
    </div>
